...
resource "azurerm_monitor_diagnostic_setting" "blob" {
  ...
  name                           = each.value.name
  target_resource_id             = "${azapi_resource.storage_account.id}/blobServices/default/"
  eventhub_authorization_rule_id = each.value.event_hub_authorization_rule_resource_id
  eventhub_name                  = each.value.event_hub_name
  log_analytics_workspace_id     = each.value.workspace_resource_id
...
resource "azurerm_monitor_diagnostic_setting" "queue" {
  ...
  name                           = each.value.name
  target_resource_id             = "${azapi_resource.storage_account.id}/queueServices/default/"
  eventhub_authorization_rule_id = each.value.event_hub_authorization_rule_resource_id
  eventhub_name                  = each.value.event_hub_name
  log_analytics_workspace_id     = each.value.workspace_resource_id
...
resource "azurerm_monitor_diagnostic_setting" "table" {
  ...
  name                           = each.value.name
  target_resource_id             = "${azapi_resource.storage_account.id}/tableServices/default/"
  eventhub_authorization_rule_id = each.value.event_hub_authorization_rule_resource_id
  eventhub_name                  = each.value.event_hub_name
  log_analytics_workspace_id     = each.value.workspace_resource_id
...
resource "azurerm_monitor_diagnostic_setting" "azure_file" {
  ...
  name                           = each.value.name
  target_resource_id             = "${azapi_resource.storage_account.id}/fileServices/default/"
  eventhub_authorization_rule_id = each.value.event_hub_authorization_rule_resource_id
  eventhub_name                  = each.value.event_hub_name
  log_analytics_workspace_id     = each.value.workspace_resource_id
